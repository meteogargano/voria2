defmodule Voria2.Network.StationApiKey do
  use Ash.Resource,
    otp_app: :voria2,
  ...
  actions do
    ...
    create :generate do
      accept [:station_id, :label]

      change fn changeset, _ ->
        key = "vsk_" <> Base.url_encode64(:crypto.strong_rand_bytes(32), padding: false)
    ...
    destroy :revoke do
      ...
      change Voria2.Network.StationApiKey.Changes.InvalidateCache
    end
