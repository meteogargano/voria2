defmodule Voria2.Measurements.HumidityMeasurement do
  use Ash.Resource,
    otp_app: :voria2,
  ...
  actions do
    ...
    create :record do
      ...
      validate compare(:value, greater_than_or_equal_to: 0.0) do
        message "humidity cannot be negative"
      end

      validate compare(:value, less_than_or_equal_to: 100.0) do
