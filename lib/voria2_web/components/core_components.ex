defmodule Voria2Web.CoreComponents do
  @moduledoc """
  ...
  def header(assigns) do
    ~H"""
    <header class={[@actions != [] && "flex items-center justify-between gap-6", "pt-2 pb-1"]}>
      <div>
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(Voria2Web.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(Voria2Web.Gettext, "errors", msg, opts)
    end
  end
