...
import RadarTimeline from "./hooks/radar_timeline"
...
const liveSocket = new LiveSocket("/live", Socket, {
  ...
  hooks: {...colocatedHooks, MaplibreMap, RadarTimeline, LineChart, WindChart, RainChart, MultiLineChart, LocalTime, InputBlur, FlatpickrInput, HugeRteInput},
})
...
document.addEventListener("change", (event) => {
  const input = event.target.closest("[data-submit-on-change='true']")
  if (!input) return
